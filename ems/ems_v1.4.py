...
def pushtoInflux():
    data = data
    with InfluxDBClient(url="http://localhost:8086", token="deNklwXuWRGQ541wLhipnmMva3renU0gt8cPW3RzVrXbteQaqZLbldCsPShkV08xUaPCJ7Mr_F6glSVs9UvMcw==", org="JBM") as _client:
